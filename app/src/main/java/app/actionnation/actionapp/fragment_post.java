 ...
 */
public class fragment_post extends Fragment implements SelectPhotoDialog.OnPhotoSelectedListener {
    ...
    private void init(){
        ...
        mPostImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.show(getFragmentManager(), "Hi How Are you?");
                dialog.setTargetFragment(fragment_post.this, 1);
            }
        });
